...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArchivedSnippet'
        db.create_table(u'base_archivedsnippet', (
        ...
        db.send_create_signal(u'base', ['ArchivedSnippet'])


    def backwards(self, orm):
        # Deleting model 'ArchivedSnippet'
        db.delete_table(u'base_archivedsnippet')


    models = {
        u'base.archivedsnippet': {
            'Meta': {'object_name': 'ArchivedSnippet'},
